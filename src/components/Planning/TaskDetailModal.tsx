...
type TaskDetailValue = string | number | undefined;
...
interface TaskDetailModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (updatedTask: TaskDetailRecord) => void;
}
...
export default function TaskDetailModal({ task, isOpen, onClose, onSave }: TaskDetailModalProps) {
  ...
  const [formData, setFormData] = useState<TaskDetailRecord>(task ?? {});

  if (!isOpen) return null;

  const handleInputChange = (field: string, value: TaskDetailValue) => {
